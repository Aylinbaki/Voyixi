    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                isDuplicate
                    ? '"${_titleCtrl.text.trim()}" A plan with that name is already on record.'
                    : 'ERROR: $e',
              ),
        ...
        children: [
          ...
          Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Expanded(
                child: Text(
                  'The plan summary will be automatically generated by artificial intelligence and a city visual will be added.',
                  style: TextStyle(
